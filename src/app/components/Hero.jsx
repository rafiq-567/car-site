...
//   { text: "Find" },
//   { text: "Your" },
//   { text: "Dream", className: "text-[#c9a84c]" },
//   { text: "Car", className: "text-[#c9a84c]" },
//   { text: "Today." },
// ];
...
const line1 = [{ text: "Find" }, { text: "Your" }];
const line2 = [{ text: "Dream", className: "text-[#c9a84c]" }, { text: "Car", className: "text-[#c9a84c]" }];
const line3 = [{ text: "Today." }];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-8 md:px-20 pt-28 pb-16 max-w-3xl">
        ...
        {/* Typewriter Heading */}
        <div className="mb-6">
          <TypewriterEffectSmooth words={line1} className="my-0" cursorClassName="hidden" />
          <TypewriterEffectSmooth words={line2} className="my-0" cursorClassName="hidden" />
          <TypewriterEffectSmooth words={line3} className="my-0" cursorClassName="hidden" />
        </div>
